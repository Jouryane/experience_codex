...
// Legacy migration asset: several items are re-exported for future controller
// surfaces but not referenced yet. Silence expected warnings; the new P1 code
// lives in the sibling `domain` and `store` modules.
