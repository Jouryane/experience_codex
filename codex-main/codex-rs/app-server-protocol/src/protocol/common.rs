...
client_request_definitions! {
    ...
    ExperienceList => "experience/list" {
        params: v2::ExperienceListParams,
        serialization: None,
        response: v2::ExperienceListResponse,
    },
    /// EXPERIMENTAL - full detail of one experience.
    ExperienceDetail => "experience/detail" {
        params: v2::ExperienceDetailParams,
        serialization: None,
        response: v2::ExperienceDetailResponse,
    },
    /// EXPERIMENTAL - grant never-forget privilege.
    ExperiencePin => "experience/pin" {
        params: v2::ExperienceIdParams,
        serialization: None,
        manual_payload_conversion: manual,
        response: v2::ExperienceActionResponse,
    },
    /// EXPERIMENTAL - revoke never-forget privilege.
    ExperienceUnpin => "experience/unpin" {
        params: v2::ExperienceIdParams,
        serialization: None,
        manual_payload_conversion: manual,
        response: v2::ExperienceActionResponse,
    },
    /// EXPERIMENTAL - activate an experience.
    ExperienceActivate => "experience/activate" {
        params: v2::ExperienceIdParams,
        serialization: None,
        manual_payload_conversion: manual,
        response: v2::ExperienceActionResponse,
    },
    /// EXPERIMENTAL - revalidate a disabled/decaying experience.
    ExperienceRevalidate => "experience/revalidate" {
        params: v2::ExperienceIdParams,
        serialization: None,
        manual_payload_conversion: manual,
        response: v2::ExperienceActionResponse,
    },
    /// EXPERIMENTAL - disable an experience.
    ExperienceDisable => "experience/disable" {
        params: v2::ExperienceIdParams,
        serialization: None,
        manual_payload_conversion: manual,
        response: v2::ExperienceActionResponse,
    },
    /// EXPERIMENTAL - delete an experience (recoverable via trash.json).
    ...
    /// EXPERIMENTAL - export one experience as JSON.
    ExperienceExport => "experience/export" {
        params: v2::ExperienceIdParams,
        serialization: None,
        response: v2::ExperienceExportResponse,
    },
    /// EXPERIMENTAL - import an experience from JSON.
    ExperienceImport => "experience/import" {
        params: v2::ExperienceImportParams,
        serialization: None,
        response: v2::ExperienceImportResponse,
    },
    /// EXPERIMENTAL - copy an experience as an editable CANDIDATE draft.
    ExperienceEditAsDraft => "experience/editAsDraft" {
        params: v2::ExperienceEditAsDraftParams,
        serialization: None,
        response: v2::ExperienceEditAsDraftResponse,
    },
    /// EXPERIMENTAL - adopt a draft and disable the replaced original.
    ExperienceAdoptDraft => "experience/adoptDraft" {
        params: v2::ExperienceAdoptDraftParams,
        serialization: None,
        response: v2::ExperienceAdoptDraftResponse,
    },
    /// EXPERIMENTAL - update display metadata (title/note/confidence).
    ExperienceUpdateMeta => "experience/updateMeta" {
        params: v2::ExperienceUpdateMetaParams,
        serialization: None,
        manual_payload_conversion: manual,
        response: v2::ExperienceUpdateResponse,
    },
    /// EXPERIMENTAL - update state/runtime applicability of an experience.
    ExperienceUpdateControl => "experience/updateControl" {
        params: v2::ExperienceUpdateControlParams,
        serialization: None,
        manual_payload_conversion: manual,
        response: v2::ExperienceUpdateResponse,
    },
